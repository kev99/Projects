...
<form action="cobrar">
  Elija su bebida:
  <input type="radio" name="bebida" value="grande">Grande<br>
  <input type="radio" name="bebida" value="mediana">Mediana<br>
   Agregar condimentos?<br> 
<input type="checkbox" name="condimentos" value="mostaza">Mostaza<br>  
  <input type="checkbox" name="condimentos" value="ketchup">Ketchup<br>  
  <input type="checkbox" name="condimentos" value="mayonesa">Mayonesa<br>  
   <input type="submit" value="Enviar Pedido" />
<input type="submit" value="Enviar Pedido" />
 </form>
 Este combo viene con una triple hamburguesa, cuádruple queso y los condimentos son opcionales.
 ...
 <form id=hform action="cobrar" method="post" >
 Pan con centeno?<br>
  ...
  <input type="hidden" name=nombrecombo value="pumpergrande"> 
<input type="submit" value="Enviar Pedido" />
    </form>
</div>
