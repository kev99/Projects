...
<input type="submit" value="Enviar Pedido" />
    ...
    Este combo viene con una cuádruple hamburguesa y una mobur de regalo (hamburguesa con huevo y pan sin centeno)
 ...
 Pan con centeno?<br>
  ...
  <input type="hidden" name=nombrecombo value="pumpersuper"> 
  <input type="submit" value="Enviar Pedido" />
    </form>
</div>
<script>
