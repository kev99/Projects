...
<input type="submit" value="Enviar Pedido" />
   ...
   Este combo viene con una doble hamburguesa con doble queso, cebolla, mayonesa y kétchup.
 ...
 Pan con centeno?<br>
  ...
  <input type="checkbox" name="condimentos" value="Con mayonesa">Mayonesa<br> 
    <input type="hidden" name=nombrecombo value="pumpermediano"> 
